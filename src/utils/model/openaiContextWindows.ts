...
const OPENAI_CONTEXT_WINDOWS: Record<string, number> = {
  ...
  // LiteLLM format — when NeveCode talks to a LiteLLM proxy, Copilot models
  ...
  // ── Local llama.cpp models — context window ───────────────────────────────
  // Prefix-match catches any GGUF filename (e.g. "Qwen3.6 35B A3B...").
  // Must match the --ctx-size set in start-llamacpp.ps1 (currently 131072).
  'Qwen':        131_072,
  'qwen':        131_072,
  'Qwopus':      131_072,
  'GLM':         131_072,
...
const OPENAI_MAX_OUTPUT_TOKENS: Record<string, number> = {
  ...
  // ── Local llama.cpp models — max output tokens ────────────────────────────
  'Qwen':        32_768,
  'qwen':        32_768,
  'Qwopus':      32_768,
  'GLM':         32_768,
