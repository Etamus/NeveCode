...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to NeveCode now.</p>
    <p>NeveCode will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in NeveCode.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in NeveCode.</p>
  </body>
</html>`
}
