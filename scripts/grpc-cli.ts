...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/nevecode.proto')
...
const nevecodeProto = protoDescriptor.nevecode.v1
...
async function main() {
  ...
  const client = new nevecodeProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mNeveCode gRPC CLI\x1b[0m')
