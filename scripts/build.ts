/**
 * NeveCode build script — bundles the TypeScript source into a single
...
const result = await Bun.build({
  ...
  define: {
    ...
    'MACRO.PACKAGE_URL': JSON.stringify('@gitlawb/nevecode'),
...
if (!result.success) {
  ...
  console.log(`✓ Built nevecode v${version} → dist/cli.mjs`)
}
